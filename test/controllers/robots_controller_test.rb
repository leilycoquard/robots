...
class RobotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create robot" do
    assert_difference('Robot.count') do
      post robots_url, params: { robot: { description: @robot.description, image: @robot.image, intro: @robot.intro, name: @robot.name } }
    end
  ...
  test "should update robot" do
    patch robot_url(@robot), params: { robot: { description: @robot.description, image: @robot.image, intro: @robot.intro, name: @robot.name } }
